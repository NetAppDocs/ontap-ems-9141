...
[.lead]
dbs.limit events are presented when a Distributed Block Store (DBS) limit event occurs, such as reaching the recommended or maximum number of volumes or virtual volumes, and no corrective action is typically required.
