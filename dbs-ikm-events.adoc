...
[.lead]
dbs.ikm events are presented when a Distributed Block Store (DBS) event relating to Internal Key Management (IKM) occurs, such as purging a key, and no corrective action is typically required.
