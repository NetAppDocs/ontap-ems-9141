...
[.lead]
dbs.ie events are presented when a Distributed Block Store (DBS) internal interface exception condition occurs, and no corrective action is typically required.
