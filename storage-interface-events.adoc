...
[.lead]
storage.interface events are presented when a storage interface reports a link down, and corrective action is to Check the system and attempt to bring the network interface back online.
