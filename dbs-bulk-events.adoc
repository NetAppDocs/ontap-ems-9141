...
[.lead]
This message occurs when a Distributed Block Store (DBS) event related to bulk volume operations such as backups, restores, making of Snapshot copies, or cloning occurs.
