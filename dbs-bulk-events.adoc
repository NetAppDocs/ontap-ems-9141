...
[.lead]
dbs.bulk events are presented when a Distributed Block Store (DBS) event related to bulk volume operations such as backups, restores, making of Snapshot copies, or cloning occurs, and no corrective action is typically required.
