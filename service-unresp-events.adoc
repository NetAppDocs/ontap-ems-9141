...
[.lead]
service.unresp events are presented when a service (Firefly, Slice Service, etc.) is detected as unresponsive and this state is committed into the Zookeeper database, and no corrective action is typically required.
