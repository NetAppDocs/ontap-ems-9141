...
[.lead]
dbs.upgrade events are presented when Distributed Block Store (DBS) detects a software upgrade is in progress longer than 24 hours, and corrective action is to Contact NetApp technical support.
