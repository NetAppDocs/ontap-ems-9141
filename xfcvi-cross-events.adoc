...
[.lead]
This message occurs when the xfcvi driver detects a cross connection *Corrective Action*:: Check the xfcvi interconnect cabling at the local and remote nodes.
