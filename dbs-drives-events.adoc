...
[.lead]
dbs.drives events are presented when Distributed Block Store (DBS) has one or more failed drives, and corrective action is to Check network connectivity for the node.
