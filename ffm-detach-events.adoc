...
[.lead]
ffm.detach events are presented when a volume becomes unavailable to protocol traffic during a graceful volume relocation, and no corrective action is typically required.
