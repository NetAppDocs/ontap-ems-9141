...
[.lead]
dbs.node events are presented when Distributed Block Store (DBS) detects a node with a maintenance mode failure, and corrective action is to Contact NetApp technical support.
