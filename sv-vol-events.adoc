...
[.lead]
This message occurs when the renaming operation of SnapVault(R) Snapshot(tm) copies belonging to a certain volume fails, even though the "vFiler rename" or "vFiler move" operation was successful.
