...
[.lead]
dbs.fault EMS events occur when a Distributed Block Store (DBS) event related to the fault checker occurs, such as the periodic fault checker taking excessive time to execute.
