...
[.lead]
This message occurs when the fcvi driver detects a cross connection *Corrective Action*:: Check the FCVI interconnect cabling at the local and remote nodes.
