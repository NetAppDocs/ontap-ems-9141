...
[.lead]
This message occurs when a Distributed Block Store (DBS) assignments event is reported, which occurs when the distribution of block data within the cluster changes.
