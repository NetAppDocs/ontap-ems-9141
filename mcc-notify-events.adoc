...
[.lead]
Failed to queue the "MetroCluster Auto Heal" job *Corrective Action*:: Manually complete the healing phase using the command "metrocluster heal aggregates" and "metrocluster heal root-aggregates" *Syslog Message*:: (None).
