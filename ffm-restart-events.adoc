...
[.lead]
ffm.restart events are presented when the Firefly manager restarts Firefly after detecting abnormal behavior, and no corrective action is typically required.
