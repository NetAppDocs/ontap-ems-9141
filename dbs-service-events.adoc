...
[.lead]
dbs.service events are presented when a Distributed Block Store (DBS) service event occurs, such as inability to start the FireStorm service, and no corrective action is typically required.
