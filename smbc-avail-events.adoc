...
[.lead]
This message occurs when the primary-bias state is set for the secondary endpoints of the SnapMirror Business Continuity (SMBC) relationships because both of the SMBC clusters lose connectivity to the ONTAP Mediator.
