...
[.lead]
This message occurs when SnapVault(R) cannot start a volume-wide Snapshot(tm) target to complete a manually invoked baseline transfer or resynchronizing transfer.
