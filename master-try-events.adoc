...
[.lead]
This message occurs when the associated node can not connect to current cluster master and tries to demote it by making associated global database change.
