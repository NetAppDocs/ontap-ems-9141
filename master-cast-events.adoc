...
[.lead]
master.cast events are presented when the master service of the associated node cannot connect to current cluster master, and no corrective action is typically required.
