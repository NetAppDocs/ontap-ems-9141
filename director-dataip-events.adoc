...
[.lead]
director.dataip events are presented when a data IP address is being reassigned from one node to another node, and no corrective action is typically required.
