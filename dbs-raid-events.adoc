...
[.lead]
dbs.raid EMS events occur when ONTAP encounters issues associated with the health of a RAID group in the cluster, such as a degraded or non-operational state.
