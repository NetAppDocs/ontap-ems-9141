...
[.lead]
dbs.clone events are presented when a Distributed Block Store (DBS) event related to volume cloning occurs, and no corrective action is typically required.
