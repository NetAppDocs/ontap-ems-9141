...
[.lead]
master.taking events are presented when the node is promoted to the cluster master and takes control as the master, and no corrective action is typically required.
