...
[.lead]
dbs.snapshot events are presented when a Distributed Block Store (DBS) event related to scheduling snapshots occurs, and no corrective action is typically required.
