...
[.lead]
dbs.cluster events are presented when a Distributed Block Store (DBS) event related to cluster operations occurs, and no corrective action is typically required.
