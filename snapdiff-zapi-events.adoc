...
[.lead]
This message occurs when the Snapshot(tm) copy differencing engine, SnapDiff, fails to obtain an appropriate file name for the requested file access protocol.
