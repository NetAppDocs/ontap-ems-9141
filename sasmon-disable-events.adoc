...
[.lead]
This message occurs when the Data ONTAP(R) module responsible for monitoring Serial Attached SCSI (SAS) domain's transient errors is disabled due to the environment variable disable-sasmon?
