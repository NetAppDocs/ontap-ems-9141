...
[.lead]
This message occurs when a disk is detected that is not supported in this version of Data ONTAP(R) or later *Corrective Action*:: Remove the disk and replace it with a disk that is supported.
