...
[.lead]
dbs.software events are presented when Distributed Block Store (DBS) detects a software version mismatch in the cluster, and corrective action is to Bring the node out of maintenance mode.
