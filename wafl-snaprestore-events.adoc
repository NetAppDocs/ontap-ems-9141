...
[.lead]
This message occurs during a Snapshot(tm) copy restore operation, when the system cannot recognize the version of Data ONTAP(R) from the Snapshot copy it is reverting to.
