...
[.lead]
This message occurs when a Logical Interface (LIF) is configured in the Logical Interface manager (VIFMgr) but is not visible in the user interface." *Corrective Action*:: Using information from the message, use the "network interface ids create" diag privilege command to create the ID.
