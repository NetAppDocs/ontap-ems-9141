...
[.lead]
dbs.stat events are presented when a Distributed Block Store (DBS) statistics event occurs, such as inconsistent statistics, and no corrective action is typically required.
